...
public class SchemaRegistryImpl implements SchemaRegistry {
	...
	@Override
	public void register(ResourceLocation id, Supplier<TypeTemplate> template) {
		this.registry.put(id.toString(), Either.left(template));
	}

	@Override
	public void register(ResourceLocation id, Function<String, TypeTemplate> template) {
	...
	@Override
	public Supplier<TypeTemplate> remove(ResourceLocation id) {
