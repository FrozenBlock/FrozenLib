...
public class FrozenParticleTypes {
	...
	public static void registerParticles() {
		FrozenLibConstants.LOGGER.info("Registering Particles for " + FrozenLibConstants.MOD_ID);
	}
	...
	private static <T extends ParticleOptions> ParticleType<T> register(
		...
		return Registry.register(BuiltInRegistries.PARTICLE_TYPE, FrozenLibConstants.id(name), new ParticleType<T>(alwaysShow) {
			@Override
