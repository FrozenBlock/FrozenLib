...
public class WeightedRuleProcessor extends StructureProcessor {
	public static final Codec<WeightedRuleProcessor> CODEC = WeightedProcessorRule.CODEC.listOf()
		.fieldOf("rules").xmap(WeightedRuleProcessor::new, processor -> processor.rules).codec();
