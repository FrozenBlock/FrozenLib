...
public class FrozenRuleBlockEntityModifiers {
	public static final RuleBlockEntityModifierType<AppendSherds> APPEND_SHERDS = register("append_sherds", AppendSherds.CODEC.codec());

	public static void init() {
	}

	private static <P extends RuleBlockEntityModifier> RuleBlockEntityModifierType<P> register(String name, Codec<P> codec) {
