...
public final class Weirdness {
    ...
    public static final Climate.Parameter[] weirdnesses =
    ...
    public static final Climate.Parameter MID_SLICE_NORMAL_ASCENDING =
            weirdnesses[0];
    public static final Climate.Parameter HIGH_SLICE_NORMAL_ASCENDING =
            weirdnesses[1];
    public static final Climate.Parameter PEAK_NORMAL = weirdnesses[2];
    public static final Climate.Parameter HIGH_SLICE_NORMAL_DESCENDING =
            weirdnesses[3];
    public static final Climate.Parameter MID_SLICE_NORMAL_DESCENDING =
            weirdnesses[4];
    public static final Climate.Parameter LOW_SLICE_NORMAL_DESCENDING =
            weirdnesses[5];
    public static final Climate.Parameter VALLEY = weirdnesses[6];
    public static final Climate.Parameter LOW_SLICE_VARIANT_ASCENDING =
            weirdnesses[7];
    public static final Climate.Parameter MID_SLICE_VARIANT_ASCENDING =
            weirdnesses[8];
    public static final Climate.Parameter HIGH_SLICE_VARIANT_ASCENDING =
            weirdnesses[9];
    public static final Climate.Parameter PEAK_VARIANT = weirdnesses[10];
    public static final Climate.Parameter HIGH_SLICE_VARIANT_DESCENDING =
            weirdnesses[11];
    public static final Climate.Parameter MID_SLICE_VARIANT_DESCENDING =
            weirdnesses[12];
