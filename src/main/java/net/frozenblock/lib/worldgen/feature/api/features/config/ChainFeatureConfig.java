...
public record ChainFeatureConfig(IntProvider height, HolderSet<Block> replaceableBlocks) implements FeatureConfiguration {
	public static final Codec<ChainFeatureConfig> CODEC = RecordCodecBuilder.create((instance) ->
		instance.group(
