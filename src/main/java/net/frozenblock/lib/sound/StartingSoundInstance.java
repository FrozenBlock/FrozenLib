...
public class StartingSoundInstance extends AbstractTickableSoundInstance {
    ...
    public final FrozenSoundPredicate.LoopPredicate<?> predicate;
    ...
    public StartingSoundInstance(Entity entity, SoundEvent startingSound, SoundEvent loopingSound, SoundSource category, float volume, float pitch, FrozenSoundPredicate.LoopPredicate<?> predicate, AbstractSoundInstance nextSound) {
