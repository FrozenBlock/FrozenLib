...
public class MovingFadingDistanceSwitchingSoundWithRestriction extends AbstractTickableSoundInstance {
    ...
    public MovingFadingDistanceSwitchingSoundWithRestriction(Entity entity, SoundEvent sound, SoundSource category, float volume, float pitch, FrozenSoundPredicate.LoopPredicate<?> predicate, double fadeDist, double maxDist, float maxVol, boolean isFarSound) {
