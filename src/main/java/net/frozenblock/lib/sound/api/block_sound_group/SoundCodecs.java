...
public final class SoundCodecs {
	...
	public static final Codec<SoundType> SOUND_TYPE = RecordCodecBuilder.create(instance ->
			instance.group(
					...
					SoundEvent.CODEC.fieldOf("break_sound").forGetter(SoundType::getBreakSound),
					SoundEvent.CODEC.fieldOf("step_sound").forGetter(SoundType::getStepSound),
					SoundEvent.CODEC.fieldOf("place_sound").forGetter(SoundType::getPlaceSound),
					SoundEvent.CODEC.fieldOf("hit_sound").forGetter(SoundType::getHitSound),
					SoundEvent.CODEC.fieldOf("fall_sound").forGetter(SoundType::getFallSound)
