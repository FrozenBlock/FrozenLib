...
public class WindChargeWindDisturbance implements WindDisturbance<AbstractWindCharge> {
	...
	@Override
	public Vec3 origin(AbstractWindCharge source, Level level) {
	...
	@Nullable
	@Override
	public DisturbanceResult get(AbstractWindCharge source, Level level, Vec3 origin, AABB area, Vec3 target, double scale) {
	...
	@Override
	public boolean expired(AbstractWindCharge source, Level level) {
