...
package net.frozenblock.lib.config.newconfig.entry.type;
...
public abstract class EntryType<T> {
	...
	public static final EntryType<Identifier> IDENTIFIER = create(Identifier.CODEC, Identifier.STREAM_CODEC);
