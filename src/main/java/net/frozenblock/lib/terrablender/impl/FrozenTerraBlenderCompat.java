...
public class FrozenTerraBlenderCompat implements TerraBlenderApi {
	...
	public void onTerraBlenderInitialized() {
		...
		for (SurfaceRules.RuleSource ruleSource : overworldSources) {
			SurfaceRuleManager.addToDefaultSurfaceRulesAtStage(SurfaceRuleManager.RuleCategory.OVERWORLD, SurfaceRuleManager.RuleStage.BEFORE_BEDROCK, 0, SurfaceRules.ifTrue(SurfaceRules.abovePreliminarySurface(), ruleSource));
		}
		...
		for (SurfaceRules.RuleSource ruleSource : overworldNoPrelimSources) {
			SurfaceRuleManager.addToDefaultSurfaceRulesAtStage(SurfaceRuleManager.RuleCategory.OVERWORLD, SurfaceRuleManager.RuleStage.BEFORE_BEDROCK, 0, ruleSource);
		}
		...
		for (SurfaceRules.RuleSource ruleSource : netherRules) {
			SurfaceRuleManager.addToDefaultSurfaceRulesAtStage(SurfaceRuleManager.RuleCategory.NETHER, SurfaceRuleManager.RuleStage.BEFORE_BEDROCK, 0, ruleSource);
		}
	}
