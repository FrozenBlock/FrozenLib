...
public final class FrozenRecipeProvider {
	...
	public static void woodenButton(Consumer<FinishedRecipe> recipeOutput, ItemLike button, ItemLike material) {
	...
	public static void woodenDoor(Consumer<FinishedRecipe> recipeOutput, ItemLike door, ItemLike material) {
		RecipeProvider.doorBuilder(door, Ingredient.of(material))
			.unlockedBy("has_planks", RecipeProvider.has(material))
			.group("wooden_door").save(recipeOutput);
	}

	public static void woodenFence(Consumer<FinishedRecipe> recipeOutput, ItemLike fence, ItemLike material) {
		RecipeProvider.fenceBuilder(fence, Ingredient.of(material))
			.unlockedBy("has_planks", RecipeProvider.has(material))
			.group("wooden_fence").save(recipeOutput);
	}

	public static void woodenFenceGate(Consumer<FinishedRecipe> recipeOutput, ItemLike fenceGate, ItemLike material) {
	...
	public static void woodenPressurePlace(Consumer<FinishedRecipe> recipeOutput, ItemLike pressurePlate, ItemLike material) {
	...
	public static void woodenSlab(Consumer<FinishedRecipe> recipeOutput, ItemLike slab, ItemLike material) {
		RecipeProvider.slabBuilder(RecipeCategory.BUILDING_BLOCKS, slab, Ingredient.of(material))
			.unlockedBy("has_planks", RecipeProvider.has(material))
			.group("wooden_slab").save(recipeOutput);
	}

	public static void woodenStairs(Consumer<FinishedRecipe> recipeOutput, ItemLike stairs, ItemLike material) {
		RecipeProvider.stairBuilder(stairs, Ingredient.of(material))
			.unlockedBy("has_planks", RecipeProvider.has(material))
			.group("wooden_stairs").save(recipeOutput);
	}

	public static void woodenTrapdoor(Consumer<FinishedRecipe> recipeOutput, ItemLike trapdoor, ItemLike material) {
		RecipeProvider.trapdoorBuilder(trapdoor, Ingredient.of(material))
			.unlockedBy("has_planks", RecipeProvider.has(material))
			.group("wooden_trapdoor").save(recipeOutput);
	}

	public static void woodenSign(Consumer<FinishedRecipe> recipeOutput, ItemLike sign, ItemLike material) {
		RecipeProvider.signBuilder(sign, Ingredient.of(material))
			.unlockedBy("has_planks", RecipeProvider.has(material))
			.group("wooden_sign").save(recipeOutput);
	}

	public static void colorWithDyes(Consumer<FinishedRecipe> recipeOutput, @NotNull List<Item> dyes, List<Item> dyeableItems, String group, RecipeCategory recipeCategory, String modID) {
