...
class GravityTests {
    ...
    void testGravity() {
        ...
        GravityAPI.register(Level.OVERWORLD, new GravityBelt<>(-64.0, -32.0, new AbsoluteGravityFunction(100.0)));
        // gravity 0.5 y 0..15
        GravityAPI.register(Level.OVERWORLD, new GravityBelt<>(0.0, 15.0, new AbsoluteGravityFunction(0.5)));
