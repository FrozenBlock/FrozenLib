...
By contributing to FrozenLib, you agree with the [Developer Certificate of Origin (DCO)][DCO].
...
Use American English to keep consistency across FrozenLib.

If there is more than one acceptable spelling of the same word, first check if one word is already
being used in FrozenLib or in Mojang's Mappings, and if not, use the spelling that is most commonly used.
