...
public final class FrozenLibModelHelper {
	...
	public static void createTintedFlowerBed(BlockModelGenerators generator, Block block) {
		...
		final MultiVariant flowerbed1 = BlockModelGenerators.plainVariant(TINTED_FLOWERBED_1.create(block, generator.modelOutput));
		final MultiVariant flowerbed2 = BlockModelGenerators.plainVariant(TINTED_FLOWERBED_2.create(block, generator.modelOutput));
		final MultiVariant flowerbed3 = BlockModelGenerators.plainVariant(TINTED_FLOWERBED_3.create(block, generator.modelOutput));
		final MultiVariant flowerbed4 = BlockModelGenerators.plainVariant(TINTED_FLOWERBED_4.create(block, generator.modelOutput));
