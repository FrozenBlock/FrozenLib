...
public class DeferredBlock<T extends Block> implements DeferredHolder<Block, T>, ItemLike {
	private final DeferredHolder<Block, T> holder;

	public DeferredBlock(DeferredHolder<Block, T> holder) {
		this.holder = holder;
	}
