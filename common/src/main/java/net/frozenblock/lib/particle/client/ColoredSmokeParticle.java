...
@ClientOnly
public class ColoredSmokeParticle extends SmokeParticle {
	final ColoredLerpedParticleHelper colorHelper;

	protected ColoredSmokeParticle(
		ClientLevel level,
		...
		super(level, x, y, z, xa, ya, za, scale, spriteSet);
		this.colorHelper = new ColoredLerpedParticleHelper(this, rDifference, gDifference, bDifference, this.lifetime);
	}
	...
	public record Provider(SpriteSet spriteSet) implements ParticleProvider<ColoredSmokeParticleOptions> {
		...
		public Particle createParticle(
			...
			return new ColoredSmokeParticle(
				level,
				x, y, z,
				xAux, yAux, zAux,
				1F,
