...
public class CircularLavaVegetationPatchLessBordersFeature extends VegetationPatchFeature {
	public static final MapCodec<CircularLavaVegetationPatchLessBordersFeature> CODEC = makeCodec(CircularLavaVegetationPatchLessBordersFeature::new);
	...
	@Override
	public boolean placeGround(WorldGenLevel level, Predicate<BlockState> replaceable, RandomSource random, MutableBlockPos belowPos, int depth) {
