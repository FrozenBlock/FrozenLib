...
public class BiomeModificationContextImpl implements BiomeModificationContext {
	...
	private class GenerationSettingsContextImpl implements GenerationSettingsContext {
		...
		@Override
		public void addCarver(ResourceKey<ConfiguredWorldCarver<?>> key) {
		...
		@Override
		public boolean removeCarver(ResourceKey<ConfiguredWorldCarver<?>> key) {
			ConfiguredWorldCarver<?> carver = getHolder(carvers, key).value();
