...
public final class FrozenLibFeatures {
	...
	public static final DeferredHolder<Feature<?>, ConfigSelectorFeature> CONFIG_SELECTOR = REGISTER.register("config_selector",
		() -> new ConfigSelectorFeature(ConfigSelectorFeatureConfiguration.CODEC)
	);
	public static final DeferredHolder<Feature<?>, NoisePathFeature> NOISE_PATH = REGISTER.register("noise_path",
		() -> new NoisePathFeature(NoisePathFeatureConfiguration.CODEC)
	);
	public static final DeferredHolder<Feature<?>, BallFeature> BALL = REGISTER.register("ball",
		() -> new BallFeature(BallFeatureConfiguration.CODEC)
	);
	public static final DeferredHolder<Feature<?>, ColumnFeature> COLUMN = REGISTER.register("column",
		() -> new ColumnFeature(ColumnFeatureConfiguration.CODEC)
	);
	public static final DeferredHolder<Feature<?>, ColumnWithDiskFeature> COLUMN_WITH_DISK = REGISTER.register("column_with_disk",
		() -> new ColumnWithDiskFeature(ColumnWithDiskFeatureConfiguration.CODEC)
	);
	public static final DeferredHolder<Feature<?>, VegetationPatchWithEdgeDecorationFeature> VEGETATION_PATCH_WITH_EDGE_DECORATION = REGISTER.register("vegetation_patch_with_edge_decoration",
		() -> new VegetationPatchWithEdgeDecorationFeature(VegetationPatchConfiguration.CODEC)
	);
	public static final DeferredHolder<Feature<?>, UnderwaterVegetationPatchFeature> UNDERWATER_VEGETATION_PATCH = REGISTER.register("underwater_vegetation_patch",
		() -> new UnderwaterVegetationPatchFeature(VegetationPatchConfiguration.CODEC)
	);
	public static final DeferredHolder<Feature<?>, UnderwaterVegetationPatchWithEdgeDecorationFeature> UNDERWATER_VEGETATION_PATCH_WITH_EDGE_DECORATION = REGISTER.register("underwater_vegetation_patch_with_edge_decoration",
		() -> new UnderwaterVegetationPatchWithEdgeDecorationFeature(VegetationPatchConfiguration.CODEC)
	);
	public static final DeferredHolder<Feature<?>, CircularWaterloggedVegetationPatchFeature> CIRCULAR_WATERLOGGED_VEGETATION_PATCH = REGISTER.register("circular_waterlogged_vegetation_patch",
		() -> new CircularWaterloggedVegetationPatchFeature(VegetationPatchConfiguration.CODEC)
	);
	public static final DeferredHolder<Feature<?>, CircularWaterloggedVegetationPatchLessBordersFeature> CIRCULAR_WATERLOGGED_VEGETATION_PATCH_LESS_BORDERS = REGISTER.register("circular_waterlogged_vegetation_patch_less_borders",
		() -> new CircularWaterloggedVegetationPatchLessBordersFeature(VegetationPatchConfiguration.CODEC)
	);
	public static final DeferredHolder<Feature<?>, CircularLavaVegetationPatchFeature> CIRCULAR_LAVA_VEGETATION_PATCH = REGISTER.register("circular_lava_vegetation_patch",
		() -> new CircularLavaVegetationPatchFeature(VegetationPatchConfiguration.CODEC)
	);
	public static final DeferredHolder<Feature<?>, CircularLavaVegetationPatchLessBordersFeature> CIRCULAR_LAVA_VEGETATION_PATCH_LESS_BORDERS = REGISTER.register("circular_lava_vegetation_patch_less_borders",
		() -> new CircularLavaVegetationPatchLessBordersFeature(VegetationPatchConfiguration.CODEC)
	);
	public static final DeferredHolder<Feature<?>, LargeSpireFeature> LARGE_SPIRE = REGISTER.register("large_spire",
		() -> new LargeSpireFeature(LargeSpireConfiguration.CODEC)
	);
	public static final DeferredHolder<Feature<?>, CurvingSpikeFeature> CURVING_SPIKE = REGISTER.register("curving_spike",
