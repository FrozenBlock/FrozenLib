...
public class CapeUtil {
	...
	public static void init() {
		Cape.init();
		registerCape(FrozenLibConstants.id("dummy"), null, Component.translatable("cape.frozenlib.dummy"));
		...
		registerCapesFromURL("https://raw.githubusercontent.com/FrozenBlock/CapeRepo/refs/heads/master/cape_directory.json");
	}
}
