 ...
 */
public class NeoForgeEvent<T> implements Event<T> {
	...
	public NeoForgeEvent(Class<T> listenerType, Function<T[], T> invokerFactory) {
	...
	private static final class BridgeEvent extends net.neoforged.bus.api.Event implements IModBusEvent {
		private final NeoForgeEvent<?> source;
		private final Method invokedMethod;
		private final Object[] invokedArgs;
		private Object result;

		private BridgeEvent(NeoForgeEvent<?> source, Method invokedMethod, Object[] invokedArgs) {
			this.source = source;
